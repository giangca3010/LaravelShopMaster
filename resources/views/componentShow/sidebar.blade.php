                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            @else
                                <a href="{{ route('categoryShow.product', ['slug'=>$category->slug, 'id'=>$category->id]) }}">
                                    <span class="badge pull-right">
                                    </span>
                                    {{ $category -> name }}
                                </a>
                        ...
                        <div class="panel-body">
                            <ul>
                                @foreach($category -> categoryChildren as $categoryChildren)
                                    <li>
                                        <a href="{{ route('categoryShow.product', ['slug'=>$categoryChildren->slug, 'id'=>$categoryChildren->id]) }}">
